        ...
        <div className="fixed top-0 w-full p-8 lg:p-12 flex justify-between items-start z-40 pointer-events-none mix-blend-difference">
            <div className="w-1/3 flex items-center gap-4 pointer-events-auto">
                ...
                <div className="relative w-8 h-8 flex items-center justify-center">
                    <div className="absolute inset-0 border-[3px] border-white rounded-sm rotate-45 transform transition-transform hover:rotate-90 duration-500" />
        ...
        <AnimatePresence>
            {isMenuOpen && (
                <motion.div 
                    ...
                    animate={{ opacity: 1, clipPath: "polygon(0 0, 100% 0, 100% 100%, 0 100%)", transition: { duration: 0.8, ease: "power3.inOut" } }}
                    ...
                    <div className="flex flex-col gap-4">
                        {['Launch App', 'Documentation', 'About Us'].map((link, i) => (
                            <motion.button 
                                ...
                                exit={{ y: -50, opacity: 0 }}
                                onClick={() => { if(link === 'Launch App') { setIsMenuOpen(false); setTimeout(onEnter, 800); } }}
